...
def print_sorted_keys(x, y, title, path):
    ...
    axes[0].bar(x[:500], y[:500])
    axes[1].bar(x[500:1000], y[500:1000])
    axes[2].bar(x[1000:1500], y[1000:1500])
    axes[3].bar(x[1500:2000], y[1500:2000])
    ...
    for i in range(4):
        ...
        axes[i].axhline(y = min_cmps, xmin = 0, xmax = 2000, color="green")
        axes[i].axhline(y = avg_cmps, xmin = 0, xmax = 2000, color="yellow")
        axes[i].axhline(y = max_cmps, xmin = 0, xmax = 2000, color="red")
...
def print_sorted_cmps(x, y, title, path):
    ...
    axes.axhline(y = min_cmps, xmin = 0, xmax = 2000, color="green")
    axes.axhline(y = avg_cmps, xmin = 0, xmax = 2000, color="yellow")
    axes.axhline(y = max_cmps, xmin = 0, xmax = 2000, color="red")
